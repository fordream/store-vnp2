...
public class ItemProgressDetailView extends LinearLayout implements
		OnClickListener, Const, IView {

	public ItemProgressDetailView(Context context) {
		super(context);
		init();
	}

	public ItemProgressDetailView(Context context, AttributeSet attrs) {
		super(context, attrs);
		init();
	...
	public View setData(ItemGetMyOrderItems itemOrder) {
