...
public class GetMyOrderDetails {
	public ItemGetMyOrderDetails details = new ItemGetMyOrderDetails();
	public void parse(String responseString) {
		if (!Common.isNullOrBlank(responseString)) {
			try {
				...
				NodeList nodes;
				nodes = document.getElementsByTagName("MyOrderDetails");
				...
				for (int i = 0; i < nodes.getLength(); i++) {
					...
					details.OrderDate = getValue(e, "OrderDate");
					...
					details.shipToAddress1String = getValue(e, "shipToAddress1String");
