...
public class MapFagment extends SupportMapFragment implements
	...
	public static final int ROOMSIZE = 14;
	...
	public void onMarkerDrag(Marker arg0) {
		// Toast.makeText(getActivity(), "onMarkerDrag",
	...
	public boolean onMarkerClick(Marker arg0) {
		// Toast.makeText(getActivity(), "onMarkerClick",
		// Toast.LENGTH_SHORT).show();
		return false;
	}
	...
	public void onInfoWindowClick(Marker arg0) {
		// Toast.makeText(getActivity(), "onInfoWindowClick",
		// Toast.LENGTH_SHORT).show();
	}
