...
public class StoreAppUtils {
	...
	public static final String URL_BASE = "https://app-server.googlecode.com/svn/trunk/storeapp/%s";
	...
	public static final String URLCONTACTFORME = String.format(URL_BASE,
			"contactforme.txt");
	...
	public static void setTextSize(View v, int size) {
		try {
			int _size = CommonAndroid.RESIZE._20130408_getSizeByScreenW960(
					v.getContext(), size);
