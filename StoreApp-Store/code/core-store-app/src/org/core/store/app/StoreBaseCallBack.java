...
public abstract class StoreBaseCallBack extends CallBack {
	...
	public StoreBaseCallBack(Context context) {
		mContext = context;
	}
	...
	public void onCallBack(Object arg0) {
		if (oCallBack != null) {
			((Context) oCallBack[0]).sendBroadcast(new Intent(oCallBack[1].toString()));
		}
	}
