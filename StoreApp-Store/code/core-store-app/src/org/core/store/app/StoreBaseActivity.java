...
public class StoreBaseActivity extends FragmentActivity implements AnimationListener, OnPageChangeListener, StoreIFunctionCommon {
	public String callBack;

	@Override
	protected void onCreate(Bundle arg0) {
		super.onCreate(arg0);
		callBack = getClass().getName() + System.currentTimeMillis();
	}
