...
public class DBConfig extends BaseDB {
	...
	public String getUpdateUrl() {
		try {
			return new JSONObject(getDataStr()).getString("update_link");
		} catch (JSONException e) {
		}
		return null;
	}
	...
	public String getAbount() {
		try {
			return new JSONObject(getDataStr()).getString("about");
		} catch (JSONException e) {
		}
		return null;
	}
	...
	public String getWeoffer() {
		try {
			return new JSONObject(getDataStr()).getString("weoffer");
		} catch (JSONException e) {
		}
		return null;
	}
