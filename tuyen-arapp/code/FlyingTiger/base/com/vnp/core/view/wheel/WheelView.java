...
package com.vnp.core.view.wheel;
...
public class WheelView extends View {
	...
	// truong vuong add
	public void setCenterDrawable(int res) {
		centerDrawable = getContext().getResources().getDrawable(res);
	}

	/**
	 * Wheel changed listener interface.
	 * <p>
	 * The onChanged() method is called whenever current wheel positions is
	 * changed:
