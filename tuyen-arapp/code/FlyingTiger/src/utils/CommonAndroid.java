...
public class CommonAndroid {
	public static final String getScreenSize(Activity context) {
		// int height = DEVICEID.getHeight(context);
		// int width = DEVICEID.getWidth(context);
		//
		// int[][] whs= new int[][]{
		// {128,75},
		// {4,3},
		...
		// if(height * whs[i][0] == width* whs[i][1]){
		// return whs[i][0] +"_"+whs[i][1];
		// }
		// }
		//
		return "128_75";
	...
	public static boolean havePackage(Context context, String strPackage) {
		// String packageSkype = "com.skype.raider";
		...
		for (PackageInfo s : lPackageInfos) {
			if (s.applicationInfo.packageName.contains(strPackage)) {
				return true;
			}
		}
